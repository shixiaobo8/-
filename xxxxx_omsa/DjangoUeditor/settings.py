...
UEditorUploadSettings={
   #上传图片配置项
    ...
    "imageFieldName": "editor", #* 提交的图片表单名称 */
    "imageUrlPrefix":"",
    "imagePathFormat":"",
    ...
    "scrawlFieldName": "editor", #提交的图片表单名称 */
    ...
    "catcherFieldName": "editor", #提交的图片列表表单名称 */
    ...
    "videoPathFormat":"",
    "videoFieldName": "editor", # 提交的视频表单名称 */
    ...
    "filePathFormat":"",
    "fileFieldName": "editor",#提交的文件表单名称 */
